...
// Generated 2014-8-24 16:39:42 by Hibernate Tools 3.4.0.CR1
...
/**
 * TBlackWhiteList generated by hbm2java
 */
@Entity
...
public class BlackWhiteList implements java.io.Serializable {
	 ...
	 * (域的意义,目的,功能)
	 */
	private static final long serialVersionUID = 6116182967453032307L;
	private String id;
	...
	public BlackWhiteList(String id, String contacts, String contactPhone, String noteName, String remarks,
			String provinceName, String cityName, Integer status, String creator, Date createDate, String modifier,
			Date modifyDate) {
		this.id = id;
