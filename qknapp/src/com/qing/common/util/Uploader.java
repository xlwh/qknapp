...
public class Uploader {
	...
	public Uploader(HttpServletRequest request) {
		...
		application = WebApplicationContextUtils.getRequiredWebApplicationContext(request.getServletContext());
	}

	public void upload() throws Exception {

		ConfigUtil util = (ConfigUtil) application.getBean("configUtil");
		...
		String savePath = this.getFolder(util.getAbsUploadPath());
	...
	private String getFolder(String path) {
		// 5SimpleDateFormat formater = new SimpleDateFormat("yyyyMMdd");

		File dir = new File(path);
		if (!dir.exists()) {
			try {
				boolean makeDirresult = dir.mkdirs();
				System.out.println("makeDirresult:" + makeDirresult);
			} catch (Exception e) {
				logger.error("Exception",e);
